...
export function App() {
  ...
  const [surfaces, setSurfaces] = useState<SurfaceVisibility>({ cowork: true, chat: true, code: false });
    ...
    return (
      <div className={"app boot-splash" + (overlay ? " tauri-overlay" : "")}>
        ...
        {overlay && (
          <div className="titlebar-drag" data-tauri-drag-region>
            <span className="titlebar-brand brand-wordmark">
              <Icon name="logo" size={13} className="mark" /> OpenRomeo
            </span>
          </div>
        )}
        {simOverlay && (
        ...
        <div className="boot-text">
          {resumedExisting ? "Restoring your session…" : "Starting OpenRomeo…"}
