// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real OpenRomeo mark
...
test("boot splash shows the OpenRomeo star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting OpenRomeo|Restoring your session/)).toBeVisible();
});
