...
const PERSONAS = {
  personas: [
    ...
    { id: "chat", name: "OpenChat", icon: "chat", tagline: "Direct chat — quick questions, no workspace", needs_workspace: false, builtin: true, family: "knowledge", workspace: "none", tools: [], enabled: true, surfaced: false, default: false },
